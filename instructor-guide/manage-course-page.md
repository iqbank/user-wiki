---
layout: default
title: Using the Manage Course Page
...
Open the page using either of the following options:

- Select **Manage Course** in the course header.
- Select **Manage Course** in the upper-right corner of the **Course Info** page.

![Manage Course page]({{ "/assets/images/instructor-guide/manage-course.png" | relative_url }})
{: .guide-image .guide-image--medium }

*The **Manage Course** page*
{: .guide-caption }

## Management Tools

Use the **Management Tools** panel to access the following features:
